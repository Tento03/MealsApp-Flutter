...
class Meal {
  ...
  static List<Meal> fromList(List<Map<String, dynamic>> list) {
...
class Meals {
  ...
  static List<Meals> fromList(List<Map<String, dynamic>> list) {
    return list.map(Meals.fromJson).toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["strMealAlternate"] = strMealAlternate;
